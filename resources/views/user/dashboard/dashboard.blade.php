...
@php
    $dashboard_content_grid_title_1 = $data_options->where('d3ti_options_name', 'dashboard_content_grid_title_1')->first();
    $dashboard_content_grid_1 = $data_options->where('d3ti_options_name', 'dashboard_content_grid_1')->first();
    $dashboard_content_grid_title_2 = $data_options->where('d3ti_options_name', 'dashboard_content_grid_title_2')->first();
    $dashboard_content_grid_2 = $data_options->where('d3ti_options_name', 'dashboard_content_grid_2')->first();
    $dashboard_content_grid_title_3 = $data_options->where('d3ti_options_name', 'dashboard_content_grid_title_3')->first();
    $dashboard_content_grid_3 = $data_options->where('d3ti_options_name', 'dashboard_content_grid_3')->first();
@endphp
                                        ...
                                        <div class="bg-white shadow d-flex align-items-center h-100 p-4" style="min-height: 150px;">
                                            <div class="d-flex">
                                                ...
                                                <div class="ps-4 text-white">
                                                    @if ($dashboard_content_grid_title_1)
                                                        <h5 class="text-white">{{ $dashboard_content_grid_title_1->d3ti_options_value }}</h5>
                                                    @endif
                                                    @if ($dashboard_content_grid_1)
                                                        <span>{{ $dashboard_content_grid_1->d3ti_options_value }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                                        <div class="bg-white shadow d-flex align-items-center h-100 p-4" style="min-height: 150px;">
                                            <div class="d-flex">
                                                ...
                                                <div class="ps-4">
                                                    @if ($dashboard_content_grid_title_2)
                                                        <h5 class="text-white">{{ $dashboard_content_grid_title_2->d3ti_options_value }}</h5>
                                                    @endif
                                                    @if ($dashboard_content_grid_2)
                                                        <span>{{ $dashboard_content_grid_2->d3ti_options_value }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                                        <div class="bg-white shadow d-flex align-items-center h-100 p-4" style="min-height: 150px;">
                                            <div class="d-flex">
                                                ...
                                                <div class="ps-4">
                                                    @if ($dashboard_content_grid_title_3)
                                                        <h5 class="text-white">{{ $dashboard_content_grid_title_3->d3ti_options_value }}</h5>
                                                    @endif
                                                    @if ($dashboard_content_grid_3)
                                                        <span>{{ $dashboard_content_grid_3->d3ti_options_value }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
